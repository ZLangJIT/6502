...
public class EGLTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    public void setEGLDebugContext(boolean debug) {
      checkRenderThreadState();
      mEGLDebugContext = debug;
    }
    ...
    public interface Renderer {
         ...
         * @param was_destroyed <code>true</code> if the context was previously destroyed
         */
        default void onEglSetup(boolean was_destroyed) {}

        /**
         * Called before the EGL context is lost
         * @param is_destroying <code>true</code> if the context is being destroyed
         */
        default void onEglTearDown(boolean is_destroying) {}
        default void onContextCreated() {}
        default void onContextDestroyed() {}
    }
    ...
    private class DefaultContextFactory implements EGLContextFactory {
        ...
        private int EGL_CONTEXT_FLAGS_KHR = 0x30FC;
        private int EGL_CONTEXT_OPENGL_DEBUG_BIT_KHR = 1;

        public EGLContext createContext(EGL10 egl, EGLDisplay display, EGLConfig config) {
            int[] attrib_list = {EGL_CONTEXT_CLIENT_VERSION, mEGLContextClientVersion,
                    EGL10.EGL_NONE };

            int[] attrib_list_debug = {EGL_CONTEXT_CLIENT_VERSION, mEGLContextClientVersion,
                    EGL_CONTEXT_FLAGS_KHR, EGL_CONTEXT_OPENGL_DEBUG_BIT_KHR,
                    EGL10.EGL_NONE };

            return egl.eglCreateContext(display, config, EGL10.EGL_NO_CONTEXT,
                    mEGLContextClientVersion != 0 ? (mEGLDebugContext ? attrib_list_debug : attrib_list) : null);
        }
    ...
    private static class EglHelper {
        ...
        public void start() {
            ...
            mEglSurface = null;
            if (view != null) {
              view.mWasDestroyed = true;
              view.mRenderer.onContextCreated();
            }
        }
        ...
        public boolean createSurface() {
            ...
            if (view != null) {
                view.mRenderer.onEglSetup(view.mWasDestroyed);
                view.mWasDestroyed = false;
            }
        ...
        private void destroySurfaceImp() {
            if (mEglSurface != null && mEglSurface != EGL10.EGL_NO_SURFACE) {
                EGLTextureView view = mEGLTextureViewWeakRef.get();
                if (view != null) {
                    view.mRenderer.onEglTearDown(false);
                }
                if (!mEgl.eglMakeCurrent(mEglDisplay, EGL10.EGL_NO_SURFACE, EGL10.EGL_NO_SURFACE, mEglContext)) {
                    /*
                     * Could not make the context current, probably because the underlying
                     * TextureView surface has been destroyed.
                     */
        ...
        public void finish() {
            ...
            if (mEglContext != null) {
                ...
                if (view != null) {
                    view.mWasDestroyed = true;
                    view.mRenderer.onEglTearDown(view.mWasDestroyed);
                    view.mRenderer.onContextDestroyed();
    ...
    private boolean mEGLDebugContext;
