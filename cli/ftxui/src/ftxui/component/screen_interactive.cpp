...
// static
ScreenInteractive * ScreenInteractive::AllocFixedSize(int dimx, int dimy) {
  return new ScreenInteractive(
      dimx,
      dimy,
      Dimension::Fixed,
      false
...
/// @note This is the same as `ScreenInteractive::FullscreenAlternateScreen()`
// static
ScreenInteractive * ScreenInteractive::AllocFullscreen() {
  return AllocFullscreenAlternateScreen();
}
...
/// content might mess up with the terminal content.
// static
ScreenInteractive * ScreenInteractive::AllocFullscreenPrimaryScreen() {
  return new ScreenInteractive(
      0,
      0,
      Dimension::Fullscreen,
...
/// alternate screen buffer to avoid messing with the terminal content.
// static
ScreenInteractive * ScreenInteractive::AllocFullscreenAlternateScreen() {
  return new ScreenInteractive(
      0,
      0,
      Dimension::Fullscreen,
...
// static
ScreenInteractive * ScreenInteractive::AllocTerminalOutput() {
  return new ScreenInteractive(
      0,
      0,
      Dimension::TerminalOutput,
...
// static
ScreenInteractive * ScreenInteractive::AllocFitComponent() {
  return new ScreenInteractive(
      0,
      0,
      Dimension::FitComponent,
