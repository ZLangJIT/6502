...
class ScreenInteractive : public Screen {
 public:
  ...
  static ScreenInteractive * AllocFixedSize(int dimx, int dimy);
  static ScreenInteractive * AllocFullscreen();
  static ScreenInteractive * AllocFullscreenPrimaryScreen();
  static ScreenInteractive * AllocFullscreenAlternateScreen();
  static ScreenInteractive * AllocFitComponent();
  static ScreenInteractive * AllocTerminalOutput();
